;;; learn-mode.el --- a minor mode for learn labs            -*- lexical-binding: t; -*-
...
If the buffer does not already exist, create it.  Ensure that the
buffer is empty, set to read-only and capable of displaying ANSI
colors."
  (kill-buffer "*learn*")
